...
const InfoCarCompleta = ({ubicacion, marca, modelo, kilometraje, velocidad, imagen}) => {
  return (
    <div class=" bg-white w-96 h-86 ml-36 border flex flex-col mt-20 rounded-2xl">
      <div>
        <img
          class="rounded-t-lg scale-75 translate-y-7 rounded-xl h-64 w-full"
          src={imagen}
          alt=""
        />
      </div>
      <div class="p-5">
        <div>
          <h5 class="mb-2 text-2xl text-left font-bold tracking-tight text-gray-900 flex gap-2">
            {modelo}
