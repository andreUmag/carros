      ...
      <section className="flex flex-row">
        <section className="w-full h-dvh basis-1/2 p-2 translate-x-20 items-center">
          <InfoCarCompleta
            ubicacion="Mamatoco"
            marca="Tesla"
            modelo="Performance 2024"
            kilometraje="1.224"
            velocidad="360"
            imagen="https://png.pngtree.com/background/20231031/original/pngtree-luxury-electric-sports-car-white-background-isolated-3d-render-picture-image_5812691.jpg"
          />
        </section>
